 ...
 *
 */
public class WavePlayerServiceImpl implements WavePlayerService
{
	...
	{
		WavePlayerServiceImpl sound = new WavePlayerServiceImpl("music/ai.wav");
	...
	public WavePlayerServiceImpl(String filename)
	{
		try
		{
