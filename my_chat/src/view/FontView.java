...
public class FontView extends JPanel {
	...
	public FontView(Font font, Color color) {
		if (font != null) {
	...
	public void showDialog(Frame parent, int x, int y) {
		...
		// 设置接界面的启动位置
		dialog.setLocation(x - dialog.getSize().width / 2, y - dialog.getSize().width / 2);
	...
	public static void main(String[] args) {
		FontView one = new FontView(new Font("方正舒体", Font.BOLD, 18), new Color(204,102,255));
